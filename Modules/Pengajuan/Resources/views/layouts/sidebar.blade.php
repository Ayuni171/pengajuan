            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href=""><i
                    ...
                    <ul class="menu-content">
                        ...
                        <li><a class="d-flex align-items-center" href="/pengajuan/pengajuanDinas"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="pengajuandinas">Pengajuan Dinas</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="/pengajuan/pengajuanProjek"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="pengajuanprojek">Pengajuan Projek</span></a>
                        </li>
                    </ul>
                <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/lihatpengajuanstaf"><i
                            ...
                            Pengajuan</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="/pengajuan/lihatPengajuanBiasa"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="pengajuanbiasa">Pengajuan Biasa</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="/pengajuan/lihatPengajuanDinas"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="pengajuandinas">Pengajuan Dinas</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="/pengajuan/lihatPengajuanProjek"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="pengajuanprojek">Pengajuan Projek</span></a>
                        </li>
                    </ul>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/revisi"><i
                            data-feather="edit"></i><span class="menu-title text-truncate" data-i18n="revisi">Revisi
                            Pengajuan</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/lampiran"><i
                            data-feather="plus-square"></i><span class="menu-title text-truncate"
                            data-i18n="lampiran">Lampiran</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/History"><i
                            data-feather="globe"></i><span class="menu-title text-truncate"
                            data-i18n="lampiran">History</span></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    <li class=" navigation-header"><span data-i18n="Apps &amp; Pages"> Approval Pengajuan </span><i
                            data-feather="more-horizontal"></i>
                    </li>
                    <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/pengajuan_masukM"><i
                                data-feather="arrow-right-circle"></i><span class="menu-item text-truncate"
                                data-i18n="pmasuk">Pengajuan Masuk</span></a>
                    </li>
                    <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/diproses"><i
                                data-feather="alert-circle"></i><span class="menu-item text-truncate"
                                data-i18n="pproses">Pengajuan Di Proses</span></a>
                    </li>
                    <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/selesai"><i
                                ...
                                data-i18n="pselesai">Pengajuan Selesai</span></a>
                    </li>
                    <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/ditolak"><i
                                ...
                                data-i18n="ptolak">Pengajuan Di Tolak</span></a>
                    </li>
                    <li class=" nav-item"><a class="d-flex align-items-center" href="/pengajuan/revisi"><i
