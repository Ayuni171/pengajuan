        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                ...
                <section class="modern-horizontal-wizard">
                    <div class="bs-stepper wizard-modern modern-wizard-example" method="POST"
                            ...
                            <div id="account-details-modern" class="content" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-12">
                                        ...
                                        <input type="email" id="keterangan" name="keterangan" class="form-control" />
                                    </div>
                                    <div class="mb-1 col-md-12">
                                                ...
                                                <div data-repeater-list="lampiran">
                                                    <div data-repeater-item>
                                                        <div class="row d-flex align-items-end">
                                                            ...
                                                            <div class="col-md-5 col-12">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="keterangan"
                                                                        name="keterangan">Keterangan</label>
                                                            ...
                                                            <div class="col-md-5 col-12">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="tambahlampiran"
                                                                        name="">Simpan File disini</label>
                                                                    <input class="form-control" type="file"
                                                                        id="tambahlampiran" name="lampiran" />
                                                                </div>
                                                            </div>
